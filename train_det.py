...
# --- Đường dẫn (THÊM CHECKPOINT PATH) ---
train_path = "data/VisDrone2019-DET-train"
val_path = "data/VisDrone2019-DET-val"
best_model_path = "models/best_model_det_final.pth"
checkpoint_path = "models/checkpoint_det_final.pth" # <-- THÊM DÒNG NÀY
...
start_epoch = 0
best_map = 0.0
# Khởi tạo optimizer và scheduler là None, sẽ được tạo sau
optimizer = None
scheduler = None
cpkt=None
...
if os.path.exists(checkpoint_path):
    ...
    # Optimizer và Scheduler sẽ được khôi phục trạng thái sau khi được tạo
