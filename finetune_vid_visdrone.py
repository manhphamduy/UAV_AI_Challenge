...
UNFROZEN_EPOCHS = 10   # Fine-tune toàn bộ 10 epoch (CÓ evaluate)
TOTAL_EPOCHS = FROZEN_EPOCHS + UNFROZEN_EPOCHS  # Tổng 13 epoch
...
pretrained_model = "models/img_best_model.pth"  # Model khởi tạo ban đầu (có thể từ ImageNet)
vid_model_path = "models/vid_best_model.pth"
checkpoint_path = "models/vid_checkpoint.pth"
...
if os.path.exists(pretrained_model):
    model.load_state_dict(torch.load(pretrained_model, map_location=device, weights_only=False))
    print(f"✅ Successfully loaded pretrained model")
else:
    print(f"⚠️ Pretrained model not found! Using ImageNet weights")
...
# ======================================================================
# GIAI ĐOẠN 2: FINE-TUNE TOÀN BỘ (10 epoch) - CÓ EVALUATE
# ======================================================================
start_epoch_stage2 = max(FROZEN_EPOCHS, start_epoch)

if start_epoch < TOTAL_EPOCHS:
    print("\n🔥 === GIAI ĐOẠN 2: FINE-TUNE TOÀN BỘ (10 EPOCH) - WITH EVALUATION ===")
